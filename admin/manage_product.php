...
if(isset($_POST['submit'])){
	...
	$mrp=get_safe_value($con,$_POST['mrp'][0]);
	$price=get_safe_value($con,$_POST['price'][0]);
	$qty=get_safe_value($con,$_POST['qty'][0]);
									...
									<div class="row"  id="image_box">
									  <div class="col-lg-10">
									   <label for="categories" class=" form-control-label">Image</label>
										...
										<?php
										if($image!=''){
echo "<a target='_blank' href='".PRODUCT_IMAGE_SITE_PATH.$image."'><img width='150px' src='".'../media/product/'.$image."'/></a>";
										}
										?>
									  </div>
									  <div class="col-lg-2">
